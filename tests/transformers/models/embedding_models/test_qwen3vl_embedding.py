...
def test_export_compile_fp16(model_name):
    ...
    check_qwen3_vl_embedding_cpu_vs_ai100_mad_parity(
        model_name, export_compile_only=True, torch_dtype=torch.float16
    )
...
def test_generate_fp16(model_name):
    ...
    check_qwen3_vl_embedding_cpu_vs_ai100_mad_parity(model_name, torch_dtype=torch.float16)
